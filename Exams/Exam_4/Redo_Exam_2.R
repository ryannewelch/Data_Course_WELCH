...
df<- read_csv("./Data/unicef-u5mr.csv") %>% janitor::clean_names()
...
#4. Save plot as PNG
ggsave("./Output/WELCH_plot_1.png",plot = p1,width=6, height=6, dpi=300)
...
ggsave("./Output/WELCH_plot_2.png",plot = p2,width=6, height=6, dpi=300)
